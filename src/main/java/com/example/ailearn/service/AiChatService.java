...
public class AiChatService {
    ...
    private String buildWeeklyReportPrompt(String data) {
        return """
            ...
            11. 数据不足时，不得要求或生成具体学校名单；如需表达学校维度，只能使用“接入学校数”“学校覆盖范围”“学校分布情况”“学校维度预警分布”等概括性表述，不得使用“各校明细”“各接入学校明细”“各接入学校的预警明细”“学校名单”“高风险区域”“重点单位”“重点监管对象”等较强指向性或结论性表述。            12. 不得自行计算占比、比例、增长率、下降率、超过一半、接近一半等数值结论；如需使用比例、占比、环比、同比等结果，必须由输入数据明确提供。
